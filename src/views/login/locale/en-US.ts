export default {
  ...
  'login.form.userName.length': 'Enter username, email or 11-digit mobile number',
  'login.form.userName.pattern': 'Enter username, email or 11-digit mobile number',
  'login.form.password.errMsg': 'Password cannot be empty',
  'login.form.login.errMsg': 'Login error, refresh and try again',
  'login.form.login.success': 'welcome to use',
  'login.form.userName.placeholder': 'Username / Email / Mobile',
